...
function getVeggies(rand) {
  const veggies = [
    ...
    },
    {
      ...
      title: "Swiss Chard",
      description:
        "Rich orange and rhubarb red attractive stems and savoyed leaves, Orange Ribbed Swiss Chard is known for its exceptional levels of dietary fiber, Vitamin A, K, Iron and antioxidants while defending against cancer, improving cognitive function and cleansing blood circulation.",
